...
from services.azure_storage_service import upload_arquivo, deletar_arquivo, CONTAINER_PRODUTOS
...
def deletar_produto(produto_id, user_id):
    ...
    try:
        ...
        if (
            ...
            and not foto_produto.startswith(("http://", "https://"))
        ):
            try:
    ...
    try:
        ...
        if arquivo_foto:
            ...
            if (
                ...
                and not foto_antiga.startswith(("http://", "https://"))
            ):
                try:
