...
def listar_produtos_produtor(user_id):
    ...
    try:
        ...
        print(
            f"Tempo total do listar_produtos_produtor: "
        ...
        if arquivo_foto:
            ...
            if (
                ...
                try:
                    ...
                    print(
                        f"Foto antiga do produto "
                        f"{produto_id} removida do Azure."
                    )
            ...
            if (
                ...
                try:
                    ...
                    print(
                        ...
                        "o novo Blob após erro no banco:",
                        str(erro_blob)
                    )
